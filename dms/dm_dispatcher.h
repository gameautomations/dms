...
string dm_call(const vector<std::string> &cmds, Idmsoft *dm) {
  ...
  case 2:
    return format(
        "{}", bstr_to_utf8(dm->Ocr(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                   stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                                   stod(cmds.at(6)))));
  case 3:
    return format("{},{},{}",
                  dm->FindStr(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                              stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                              encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)), &x,
                              &y),
                  x.intVal, y.intVal);
  case 4:
  ...
  case 5:
    return format(
        "{},{},{}",
        dm->GetResultPos(encoded_uri_component_to_bstr(cmds.at(1)), stol(cmds.at(2)), &x, &y),
        x.intVal, y.intVal);
  case 6:
  ...
  case 11:
    return format("{}", bstr_to_utf8(dm->OcrInFile(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)))));
  case 12:
    return format("{}",
                  dm->Capture(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                              stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5))));
  case 13:
  ...
  case 31:
    return format("{}",
                  dm->CmpColor(stol(cmds.at(1)), stol(cmds.at(2)),
                               encoded_uri_component_to_bstr(cmds.at(3)), stod(cmds.at(4))));
  case 32:
    return format("{},{},{}", dm->ClientToScreen(stol(cmds.at(1)), &x, &y), x.intVal,
                  y.intVal);
  case 33:
    return format("{},{},{}", dm->ScreenToClient(stol(cmds.at(1)), &x, &y), x.intVal,
                  y.intVal);
  case 34:
    return format("{}",
                  dm->ShowScrMsg(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                 stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
  ...
  case 37:
    return format("{},{},{}",
                  dm->FindColor(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                                stod(cmds.at(6)), stol(cmds.at(7)), &x, &y),
                  x.intVal, y.intVal);
  case 38:
    return format("{}", bstr_to_utf8(dm->FindColorEx(stol(cmds.at(1)), stol(cmds.at(2)),
  ...
  case 46:
    return format("{},{},{}",
                  dm->GetWordResultPos(encoded_uri_component_to_bstr(cmds.at(1)),
                                       stol(cmds.at(2)), &x, &y),
                  x.intVal, y.intVal);
  case 47:
    return format("{}", bstr_to_utf8(dm->GetWordResultStr(
                            encoded_uri_component_to_bstr(cmds.at(1)), stol(cmds.at(2)))));
  case 48:
    return format("{}", bstr_to_utf8(dm->GetWords(stol(cmds.at(1)), stol(cmds.at(2)),
                                                  stol(cmds.at(3)), stol(cmds.at(4)),
                                                  encoded_uri_component_to_bstr(cmds.at(5)),
                                                  stod(cmds.at(6)))));
  case 49:
    return format("{}", bstr_to_utf8(dm->GetWordsNoDict(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)))));
  case 50:
    return format("{}", dm->SetShowErrorMsg(stol(cmds.at(1))));
  case 51:
    return format("{},{},{}", dm->GetClientSize(stol(cmds.at(1)), &width, &height),
                  width.intVal, height.intVal);
  case 52:
  ...
  case 54:
    return format("{}", bstr_to_utf8(dm->GetAveRGB(stol(cmds.at(1)), stol(cmds.at(2)),
                                                   stol(cmds.at(3)), stol(cmds.at(4)))));
  case 55:
    return format("{}", bstr_to_utf8(dm->GetAveHSV(stol(cmds.at(1)), stol(cmds.at(2)),
                                                   stol(cmds.at(3)), stol(cmds.at(4)))));
  case 56:
  ...
  case 60:
    return format("{}", bstr_to_utf8(dm->EnumWindow(
                            stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
  ...
  case 64:
    return format(
        "{}", dm->SetWindowText(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2))));
  case 65:
    return format("{}",
                  dm->SetWindowSize(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3))));
  case 66:
    return format("{},{},{},{},{}", dm->GetWindowRect(stol(cmds.at(1)), &x1, &y1, &x2, &y2),
                  x1.intVal, y1.intVal, x2.intVal, y2.intVal);
  case 67:
  ...
  case 70:
    return format("{}",
                  dm->CreateFoobarRect(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                       stol(cmds.at(4)), stol(cmds.at(5))));
  case 71:
    return format("{}", dm->CreateFoobarRoundRect(stol(cmds.at(1)), stol(cmds.at(2)),
                                                  stol(cmds.at(3)), stol(cmds.at(4)),
                                                  stol(cmds.at(5)), stol(cmds.at(6)),
                                                  stol(cmds.at(7))));
  case 72:
    return format("{}",
                  dm->CreateFoobarEllipse(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                          stol(cmds.at(4)), stol(cmds.at(5))));
  case 73:
    return format("{}", dm->CreateFoobarCustom(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            encoded_uri_component_to_bstr(cmds.at(4)),
                            encoded_uri_component_to_bstr(cmds.at(5)), stod(cmds.at(6))));
  case 74:
    return format("{}",
                  dm->FoobarFillRect(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                     stol(cmds.at(4)), stol(cmds.at(5)),
                                     encoded_uri_component_to_bstr(cmds.at(6))));
  case 75:
    return format(
        "{}", dm->FoobarDrawText(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                 stol(cmds.at(4)), stol(cmds.at(5)),
                                 encoded_uri_component_to_bstr(cmds.at(6)),
  ...
  case 80:
    return format("{}", dm->FoobarSetFont(stol(cmds.at(1)),
                                          encoded_uri_component_to_bstr(cmds.at(2)),
                                          stol(cmds.at(3)), stol(cmds.at(4))));
  case 81:
    return format("{}",
                  dm->FoobarTextRect(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                     stol(cmds.at(4)), stol(cmds.at(5))));
  case 82:
    return format("{}", dm->FoobarPrintText(stol(cmds.at(1)),
                                            encoded_uri_component_to_bstr(cmds.at(2)),
  ...
  case 86:
    return format("{}", dm->FaqCapture(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
  ...
  case 88:
    return format(
        "{}", bstr_to_utf8(dm->FaqSend(encoded_uri_component_to_bstr(cmds.at(1)),
  ...
  case 95:
    return format("{}", dm->GetScreenData(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                          stol(cmds.at(4))));
  case 96:
  ...
  case 99:
    return format(
        "{}", dm->SetMouseDelay(encoded_uri_component_to_bstr(cmds.at(1)), stol(cmds.at(2))));
  case 100:
    return format(
        "{}", dm->SetKeypadDelay(encoded_uri_component_to_bstr(cmds.at(1)), stol(cmds.at(2))));
  case 101:
    return format("{}", bstr_to_utf8(dm->GetEnv(stol(cmds.at(1)),
                                                encoded_uri_component_to_bstr(cmds.at(2)))));
  case 102:
  ...
  case 103:
    return format("{}",
                  dm->SendString(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2))));
  case 104:
    return format("{}",
                  dm->DelEnv(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2))));
  case 105:
    return format("{}", bstr_to_utf8(dm->GetPath()));
  case 106:
    return format("{}",
                  dm->SetDict(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2))));
  case 107:
    return format("{},{},{}",
                  dm->FindPic(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                              stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                              encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)),
                              stol(cmds.at(8)), &x, &y),
                  x.intVal, y.intVal);
  case 108:
    return format("{}", bstr_to_utf8(dm->FindPicEx(stol(cmds.at(1)), stol(cmds.at(2)),
                                                   stol(cmds.at(3)), stol(cmds.at(4)),
                                                   encoded_uri_component_to_bstr(cmds.at(5)),
                                                   encoded_uri_component_to_bstr(cmds.at(6)),
  ...
  case 110:
    return format("{}",
                  dm->ReadInt(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                              stol(cmds.at(3))));
  case 111:
    return format("{}",
                  dm->ReadFloat(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2))));
  case 112:
    return format("{}",
                  dm->ReadDouble(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2))));
  case 113:
    return format("{}", bstr_to_utf8(dm->FindInt(
                            stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                            stoll(cmds.at(3)), stoll(cmds.at(4)), stol(cmds.at(5)))));
  case 114:
    return format("{}", bstr_to_utf8(dm->FindFloat(stol(cmds.at(1)),
                                                   encoded_uri_component_to_bstr(cmds.at(2)),
                                                   stof(cmds.at(3)), stof(cmds.at(4)))));
  case 115:
    return format("{}", bstr_to_utf8(dm->FindDouble(stol(cmds.at(1)),
                                                    encoded_uri_component_to_bstr(cmds.at(2)),
                                                    stod(cmds.at(3)), stod(cmds.at(4)))));
  case 116:
    return format("{}", bstr_to_utf8(dm->FindString(
                            stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                            encoded_uri_component_to_bstr(cmds.at(3)), stol(cmds.at(4)))));
  case 117:
    return format("{}", dm->GetModuleBaseAddr(stol(cmds.at(1)),
                                              encoded_uri_component_to_bstr(cmds.at(2))));
  case 118:
    return format("{}", bstr_to_utf8(dm->MoveToEx(stol(cmds.at(1)), stol(cmds.at(2)),
                                                  stol(cmds.at(3)), stol(cmds.at(4)))));
  case 119:
    return format("{}",
                  bstr_to_utf8(dm->MatchPicName(encoded_uri_component_to_bstr(cmds.at(1)))));
  case 120:
    return format("{}",
                  dm->AddDict(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2))));
  case 121:
  ...
  case 123:
    return format("{}",
                  dm->WriteInt(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                               stol(cmds.at(3)), stoll(cmds.at(4))));
  case 124:
    return format("{}",
                  dm->WriteFloat(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                                 stof(cmds.at(3))));
  case 125:
    return format("{}",
                  dm->WriteDouble(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                                  stod(cmds.at(3))));
  case 126:
    return format(
        "{}", dm->WriteString(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
  ...
  case 130:
    return format("{},{},{}",
                  dm->FindMultiColor(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                     stol(cmds.at(4)),
                                     encoded_uri_component_to_bstr(cmds.at(5)),
                                     encoded_uri_component_to_bstr(cmds.at(6)),
                                     stod(cmds.at(7)), stol(cmds.at(8)), &x, &y),
                  x.intVal, y.intVal);
  case 131:
    return format("{}", bstr_to_utf8(dm->FindMultiColorEx(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)),
                            stol(cmds.at(8)))));
  ...
  case 133:
    return format("{}", bstr_to_utf8(dm->DisAssemble(encoded_uri_component_to_bstr(cmds.at(1)),
                                                     stoll(cmds.at(2)), stol(cmds.at(3)))));
  case 134:
    return format("{}", dm->SetWindowTransparent(stol(cmds.at(1)), stol(cmds.at(2))));
  case 135:
    return format("{}", bstr_to_utf8(dm->ReadData(stol(cmds.at(1)),
                                                  encoded_uri_component_to_bstr(cmds.at(2)),
                                                  stol(cmds.at(3)))));
  case 136:
    return format("{}",
                  dm->WriteData(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                                encoded_uri_component_to_bstr(cmds.at(3))));
  case 137:
    return format("{}", bstr_to_utf8(dm->FindData(stol(cmds.at(1)),
                                                  encoded_uri_component_to_bstr(cmds.at(2)),
                                                  encoded_uri_component_to_bstr(cmds.at(3)))));
  case 138:
  ...
  case 140:
    return format("{}", bstr_to_utf8(dm->FindStrE(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)))));
  case 141:
    return format("{}", bstr_to_utf8(dm->FindColorE(stol(cmds.at(1)), stol(cmds.at(2)),
                                                    stol(cmds.at(3)), stol(cmds.at(4)),
                                                    encoded_uri_component_to_bstr(cmds.at(5)),
                                                    stod(cmds.at(6)), stol(cmds.at(7)))));
  case 142:
    return format("{}", bstr_to_utf8(dm->FindPicE(stol(cmds.at(1)), stol(cmds.at(2)),
                                                  stol(cmds.at(3)), stol(cmds.at(4)),
                                                  encoded_uri_component_to_bstr(cmds.at(5)),
                                                  encoded_uri_component_to_bstr(cmds.at(6)),
                                                  stod(cmds.at(7)), stol(cmds.at(8)))));
  case 143:
    return format("{}", bstr_to_utf8(dm->FindMultiColorE(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)),
                            stol(cmds.at(8)))));
  ...
  case 145:
    return format("{}", bstr_to_utf8(dm->ReadString(stol(cmds.at(1)),
                                                    encoded_uri_component_to_bstr(cmds.at(2)),
                                                    stol(cmds.at(3)), stol(cmds.at(4)))));
  case 146:
    return format("{}", dm->FoobarTextPrintDir(stol(cmds.at(1)), stol(cmds.at(2))));
  case 147:
    return format("{}", bstr_to_utf8(dm->OcrEx(stol(cmds.at(1)), stol(cmds.at(2)),
                                               stol(cmds.at(3)), stol(cmds.at(4)),
                                               encoded_uri_component_to_bstr(cmds.at(5)),
                                               stod(cmds.at(6)))));
  case 148:
  ...
  case 152:
    return format(
        "{}", dm->BindWindowEx(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                               encoded_uri_component_to_bstr(cmds.at(3)),
                               encoded_uri_component_to_bstr(cmds.at(4)),
  ...
  case 156:
    return format("{}", dm->ActiveInputMethod(stol(cmds.at(1)),
                                              encoded_uri_component_to_bstr(cmds.at(2))));
  case 157:
    return format("{}", dm->CheckInputMethod(stol(cmds.at(1)),
                                             encoded_uri_component_to_bstr(cmds.at(2))));
  case 158:
  ...
  case 160:
    return format("{}",
                  dm->BindWindow(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                                 encoded_uri_component_to_bstr(cmds.at(3)),
  ...
  case 167:
    return format("{}",
                  dm->FindWindowEx(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                                   encoded_uri_component_to_bstr(cmds.at(3))));
  case 168:
    return format(
        "{}", dm->SetExportDict(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2))));
  case 169:
  ...
  case 172:
    return format(
        "{}", dm->SendString2(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2))));
  case 173:
    return format("{}", dm->FaqPost(encoded_uri_component_to_bstr(cmds.at(1)),
                                    stol(cmds.at(2)), stol(cmds.at(3)), stol(cmds.at(4))));
  case 174:
    return format("{}", bstr_to_utf8(dm->FaqFetch()));
  case 175:
    return format("{}", bstr_to_utf8(dm->FetchWord(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)))));
  case 176:
    return format("{}",
                  dm->CaptureJpg(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                 stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                                 stol(cmds.at(6))));
  case 177:
    return format(
        "{},{},{}",
        dm->FindStrWithFont(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)),
        ...
        x.intVal, y.intVal);
  case 178:
    return format("{}", bstr_to_utf8(dm->FindStrWithFontE(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)),
                            encoded_uri_component_to_bstr(cmds.at(8)), stol(cmds.at(9)),
                            stol(cmds.at(10)))));
  case 179:
    return format("{}", bstr_to_utf8(dm->FindStrWithFontEx(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)),
                            encoded_uri_component_to_bstr(cmds.at(8)), stol(cmds.at(9)),
  ...
  case 181:
    return format("{}",
                  dm->SaveDict(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2))));
  case 182:
  ...
  case 185:
    return format("{}",
                  bstr_to_utf8(dm->GetPicSize(encoded_uri_component_to_bstr(cmds.at(1)))));
  case 186:
    return format("{}", dm->GetID());
  case 187:
    return format("{}",
                  dm->CapturePng(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                 stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5))));
  case 188:
    return format("{}",
                  dm->CaptureGif(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                 stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
  ...
  case 190:
    return format("{},{},{}",
                  dm->FindStrFast(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                  stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                                  encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)),
                                  &x, &y),
                  x.intVal, y.intVal);
  case 191:
    return format("{}", bstr_to_utf8(dm->FindStrFastEx(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)))));
  case 192:
    return format("{}", bstr_to_utf8(dm->FindStrFastE(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)))));
  case 193:
  ...
  case 201:
    return format("{}",
                  dm->GetColorNum(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                  stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                                  stod(cmds.at(6))));
  case 202:
    return format("{}", bstr_to_utf8(dm->EnumWindowByProcess(
                            encoded_uri_component_to_bstr(cmds.at(1)),
                            encoded_uri_component_to_bstr(cmds.at(2)),
                            encoded_uri_component_to_bstr(cmds.at(3)), stol(cmds.at(4)))));
  case 203:
  ...
  case 212:
    return format("{}", dm->FindWindowByProcess(encoded_uri_component_to_bstr(cmds.at(1)),
                                                ...
                                                encoded_uri_component_to_bstr(cmds.at(3))));
  case 213:
    return format("{}", dm->FindWindowByProcessId(stol(cmds.at(1)),
                                                  encoded_uri_component_to_bstr(cmds.at(2)),
                                                  encoded_uri_component_to_bstr(cmds.at(3))));
  case 214:
  ...
  case 216:
    return format("{}",
                  dm->RunApp(encoded_uri_component_to_bstr(cmds.at(1)), stol(cmds.at(2))));
  case 217:
    return format("{}", dm->delay(stol(cmds.at(1))));
  case 218:
    return format("{}", dm->FindWindowSuper(encoded_uri_component_to_bstr(cmds.at(1)),
                                            stol(cmds.at(2)), stol(cmds.at(3)),
                                            encoded_uri_component_to_bstr(cmds.at(4)),
                                            stol(cmds.at(5)), stol(cmds.at(6))));
  case 219:
    return format(
        "{}", bstr_to_utf8(dm->ExcludePos(encoded_uri_component_to_bstr(cmds.at(1)),
                                          stol(cmds.at(2)), stol(cmds.at(3)), stol(cmds.at(4)),
                                          stol(cmds.at(5)), stol(cmds.at(6)))));
  case 220:
    return format("{}", bstr_to_utf8(dm->FindNearestPos(
                            encoded_uri_component_to_bstr(cmds.at(1)), stol(cmds.at(2)),
                            stol(cmds.at(3)), stol(cmds.at(4)))));
  case 221:
    return format("{}", bstr_to_utf8(dm->SortPosDistance(
                            encoded_uri_component_to_bstr(cmds.at(1)), stol(cmds.at(2)),
                            stol(cmds.at(3)), stol(cmds.at(4)))));
  case 222:
    return format("{},{},{}",
                  dm->FindPicMem(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                 stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                                 encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)),
                                 stol(cmds.at(8)), &x, &y),
                  x.intVal, y.intVal);
  case 223:
    return format("{}", bstr_to_utf8(dm->FindPicMemEx(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)),
                            stol(cmds.at(8)))));
  case 224:
    return format("{}", bstr_to_utf8(dm->FindPicMemE(stol(cmds.at(1)), stol(cmds.at(2)),
                                                     stol(cmds.at(3)), stol(cmds.at(4)),
                                                     encoded_uri_component_to_bstr(cmds.at(5)),
                                                     encoded_uri_component_to_bstr(cmds.at(6)),
                                                     stod(cmds.at(7)), stol(cmds.at(8)))));
  case 225:
    return format("{}",
                  bstr_to_utf8(dm->AppendPicAddr(encoded_uri_component_to_bstr(cmds.at(1)),
                                                 stol(cmds.at(2)), stol(cmds.at(3)))));
  case 226:
  ...
  case 231:
    return format("{}",
                  bstr_to_utf8(dm->ReadIniPwd(encoded_uri_component_to_bstr(cmds.at(1)),
                                              encoded_uri_component_to_bstr(cmds.at(2)),
                                              encoded_uri_component_to_bstr(cmds.at(3)),
                                              encoded_uri_component_to_bstr(cmds.at(4)))));
  case 232:
  ...
  case 237:
    return format(
        "{}", dm->KeyPressStr(encoded_uri_component_to_bstr(cmds.at(1)), stol(cmds.at(2))));
  case 238:
  ...
  case 241:
    return format("{}",
                  dm->DmGuard(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2))));
  case 242:
    return format("{}", dm->FaqCaptureFromFile(stol(cmds.at(1)), stol(cmds.at(2)),
                                               stol(cmds.at(3)), stol(cmds.at(4)),
                                               encoded_uri_component_to_bstr(cmds.at(5)),
                                               stol(cmds.at(6))));
  case 243:
    return format("{}", bstr_to_utf8(dm->FindIntEx(
                            stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                            stoll(cmds.at(3)), stoll(cmds.at(4)), stol(cmds.at(5)),
                            stol(cmds.at(6)), stol(cmds.at(7)), stol(cmds.at(8)))));
  case 244:
    return format("{}", bstr_to_utf8(dm->FindFloatEx(
                            stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                            stof(cmds.at(3)), stof(cmds.at(4)), stol(cmds.at(5)),
                            stol(cmds.at(6)), stol(cmds.at(7)))));
  case 245:
    return format("{}", bstr_to_utf8(dm->FindDoubleEx(
                            stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                            stod(cmds.at(3)), stod(cmds.at(4)), stol(cmds.at(5)),
                            stol(cmds.at(6)), stol(cmds.at(7)))));
  case 246:
    return format("{}", bstr_to_utf8(dm->FindStringEx(
                            stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                            encoded_uri_component_to_bstr(cmds.at(3)), stol(cmds.at(4)),
                            stol(cmds.at(5)), stol(cmds.at(6)), stol(cmds.at(7)))));
  case 247:
    return format("{}", bstr_to_utf8(dm->FindDataEx(
                            stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                            encoded_uri_component_to_bstr(cmds.at(3)), stol(cmds.at(4)),
                            stol(cmds.at(5)), stol(cmds.at(6)))));
  case 248:
  ...
  case 251:
    return format("{}",
                  dm->FoobarDrawLine(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                     stol(cmds.at(4)), stol(cmds.at(5)),
                                     encoded_uri_component_to_bstr(cmds.at(6)),
                                     stol(cmds.at(7)), stol(cmds.at(8))));
  case 252:
    return format("{}", bstr_to_utf8(dm->FindStrEx(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)))));
  case 253:
  ...
  case 259:
    return format("{},{},{}",
                  dm->FindShape(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                                stod(cmds.at(6)), stol(cmds.at(7)), &x, &y),
                  x.intVal, y.intVal);
  case 260:
    return format("{}", bstr_to_utf8(dm->FindShapeE(stol(cmds.at(1)), stol(cmds.at(2)),
                                                    stol(cmds.at(3)), stol(cmds.at(4)),
                                                    encoded_uri_component_to_bstr(cmds.at(5)),
                                                    stod(cmds.at(6)), stol(cmds.at(7)))));
  case 261:
    return format("{}", bstr_to_utf8(dm->FindShapeEx(stol(cmds.at(1)), stol(cmds.at(2)),
                                                     stol(cmds.at(3)), stol(cmds.at(4)),
                                                     encoded_uri_component_to_bstr(cmds.at(5)),
                                                     stod(cmds.at(6)), stol(cmds.at(7)))));
  case 262:
    return format("{},{},{}",
                  bstr_to_utf8(dm->FindStrS(
                      stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)), stol(cmds.at(4)),
                      encoded_uri_component_to_bstr(cmds.at(5)),
                      encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)), &x, &y)),
                  x.intVal, y.intVal);
  case 263:
    return format("{}", bstr_to_utf8(dm->FindStrExS(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)))));
  case 264:
    return format("{},{},{}",
                  bstr_to_utf8(dm->FindStrFastS(
                      stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)), stol(cmds.at(4)),
                      encoded_uri_component_to_bstr(cmds.at(5)),
                      encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)), &x, &y)),
                  x.intVal, y.intVal);
  case 265:
    return format("{}", bstr_to_utf8(dm->FindStrFastExS(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)))));
  case 266:
    return format(
        "{},{},{}",
        bstr_to_utf8(dm->FindPicS(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                  stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                                  encoded_uri_component_to_bstr(cmds.at(6)), stod(cmds.at(7)),
                                  stol(cmds.at(8)), &x, &y)),
        x.intVal, y.intVal);
  case 267:
    return format("{}", bstr_to_utf8(dm->FindPicExS(stol(cmds.at(1)), stol(cmds.at(2)),
                                                    stol(cmds.at(3)), stol(cmds.at(4)),
                                                    encoded_uri_component_to_bstr(cmds.at(5)),
                                                    encoded_uri_component_to_bstr(cmds.at(6)),
                                                    stod(cmds.at(7)), stol(cmds.at(8)))));
  ...
  case 270:
    return format("{},{},{},{},{}", dm->GetClientRect(stol(cmds.at(1)), &x1, &y1, &x2, &y2),
                  x1.intVal, y1.intVal, x2.intVal, y2.intVal);
  case 271:
    return format("{}", dm->EnableFakeActive(stol(cmds.at(1))));
  case 272:
    return format("{},{},{}",
                  dm->GetScreenDataBmp(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                       stol(cmds.at(4)), &data, &size),
                  data.intVal, size.intVal);
  case 273:
  ...
  case 279:
    return format("{}", bstr_to_utf8(dm->StringToData(
                            encoded_uri_component_to_bstr(cmds.at(1)), stol(cmds.at(2)))));
  case 280:
    return format("{}",
                  dm->SetMemoryFindResultToFile(encoded_uri_component_to_bstr(cmds.at(1))));
  case 281:
    return format("{}", dm->EnableBind(stol(cmds.at(1))));
  case 282:
    return format("{}", dm->SetSimMode(stol(cmds.at(1))));
  case 283:
    return format("{}", dm->LockMouseRect(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                          stol(cmds.at(4))));
  case 284:
    return format("{}", dm->SendPaste(stol(cmds.at(1))));
  case 285:
    return format("{}", dm->IsDisplayDead(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                          stol(cmds.at(4)), stol(cmds.at(5))));
  case 286:
    return format("{}", dm->GetKeyState(stol(cmds.at(1))));
  case 287:
    return format("{}",
                  dm->CopyFile(encoded_uri_component_to_bstr(cmds.at(1)),
  ...
  case 304:
    return format(
        "{}", dm->FoobarSetSave(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                                stol(cmds.at(3)), encoded_uri_component_to_bstr(cmds.at(4))));
  case 305:
    return format("{}", bstr_to_utf8(dm->EnumWindowSuper(
                            encoded_uri_component_to_bstr(cmds.at(1)), stol(cmds.at(2)),
                            stol(cmds.at(3)), encoded_uri_component_to_bstr(cmds.at(4)),
                            stol(cmds.at(5)), stol(cmds.at(6)), stol(cmds.at(7)))));
  case 306:
  ...
  case 312:
    return format("{}",
                  dm->FindMulColor(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                   stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                                   stod(cmds.at(6))));
  case 313:
  ...
  case 315:
    return format("{}",
                  dm->FoobarStartGif(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                     encoded_uri_component_to_bstr(cmds.at(4)),
                                     stol(cmds.at(5)), stol(cmds.at(6))));
  case 316:
  ...
  case 318:
    return format("{}",
                  bstr_to_utf8(dm->ReadFileData(encoded_uri_component_to_bstr(cmds.at(1)),
                                                stol(cmds.at(2)), stol(cmds.at(3)))));
  case 319:
    return format("{}", dm->VirtualAllocEx(stol(cmds.at(1)), stoll(cmds.at(2)),
                                           stol(cmds.at(3)), stol(cmds.at(4))));
  case 320:
  ...
  case 323:
    return format("{}",
                  bstr_to_utf8(dm->GetNetTimeByIp(encoded_uri_component_to_bstr(cmds.at(1)))));
  case 324:
    return format("{}",
                  bstr_to_utf8(dm->EnumProcess(encoded_uri_component_to_bstr(cmds.at(1)))));
  case 325:
  ...
  case 327:
    return format("{}", bstr_to_utf8(dm->ReadDataAddr(stol(cmds.at(1)), stoll(cmds.at(2)),
                                                      stol(cmds.at(3)))));
  case 328:
  ...
  case 330:
    return format("{}", bstr_to_utf8(dm->ReadStringAddr(stol(cmds.at(1)), stoll(cmds.at(2)),
                                                        stol(cmds.at(3)), stol(cmds.at(4)))));
  case 331:
  ...
  case 334:
    return format("{}", dm->WriteIntAddr(stol(cmds.at(1)), stoll(cmds.at(2)), stol(cmds.at(3)),
                                         stoll(cmds.at(4))));
  case 335:
    return format("{}",
                  dm->WriteStringAddr(stol(cmds.at(1)), stoll(cmds.at(2)), stol(cmds.at(3)),
                                      encoded_uri_component_to_bstr(cmds.at(4))));
  case 336:
  ...
  case 337:
    return format("{},{},{}",
                  dm->FindColorBlock(
                      stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)), stol(cmds.at(4)),
                      encoded_uri_component_to_bstr(cmds.at(5)), stod(cmds.at(6)),
                      stol(cmds.at(7)), stol(cmds.at(8)), stol(cmds.at(9)), &x, &y),
                  x.intVal, y.intVal);
  case 338:
    return format("{}",
                  bstr_to_utf8(dm->FindColorBlockEx(
                      stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)), stol(cmds.at(4)),
                      encoded_uri_component_to_bstr(cmds.at(5)), stod(cmds.at(6)),
                      stol(cmds.at(7)), stol(cmds.at(8)), stol(cmds.at(9)))));
  case 339:
    return format("{}", dm->OpenProcess(stol(cmds.at(1))));
  case 340:
    return format("{}",
                  bstr_to_utf8(dm->EnumIniSection(encoded_uri_component_to_bstr(cmds.at(1)))));
  case 341:
    return format(
        "{}", bstr_to_utf8(dm->EnumIniSectionPwd(encoded_uri_component_to_bstr(cmds.at(1)),
                                                 encoded_uri_component_to_bstr(cmds.at(2)))));
  case 342:
    return format("{}",
                  bstr_to_utf8(dm->EnumIniKey(encoded_uri_component_to_bstr(cmds.at(1)),
                                              encoded_uri_component_to_bstr(cmds.at(2)))));
  case 343:
    return format("{}",
                  bstr_to_utf8(dm->EnumIniKeyPwd(encoded_uri_component_to_bstr(cmds.at(1)),
                                                 encoded_uri_component_to_bstr(cmds.at(2)),
                                                 encoded_uri_component_to_bstr(cmds.at(3)))));
  case 344:
  ...
  case 346:
    return format("{}", dm->SendStringIme2(stol(cmds.at(1)),
                                           encoded_uri_component_to_bstr(cmds.at(2)),
                                           stol(cmds.at(3))));
  case 347:
    return format("{}", bstr_to_utf8(dm->EnumWindowByProcessId(
                            stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2)),
                            encoded_uri_component_to_bstr(cmds.at(3)), stol(cmds.at(4)))));
  case 348:
  ...
  case 350:
    return format("{}", bstr_to_utf8(dm->OcrExOne(stol(cmds.at(1)), stol(cmds.at(2)),
                                                  stol(cmds.at(3)), stol(cmds.at(4)),
                                                  encoded_uri_component_to_bstr(cmds.at(5)),
                                                  stod(cmds.at(6)))));
  case 351:
  ...
  case 359:
    return format("{}",
                  dm->VirtualProtectEx(stol(cmds.at(1)), stoll(cmds.at(2)), stol(cmds.at(3)),
                                       stol(cmds.at(4)), stol(cmds.at(5))));
  case 360:
  ...
  case 363:
    return format("{}", dm->SetExcludeRegion(stol(cmds.at(1)),
                                             encoded_uri_component_to_bstr(cmds.at(2))));
  case 364:
  ...
  case 369:
    return format("{}", dm->ReadDataToBin(stol(cmds.at(1)),
                                          encoded_uri_component_to_bstr(cmds.at(2)),
                                          stol(cmds.at(3))));
  case 370:
    return format("{}", dm->WriteDataFromBin(stol(cmds.at(1)),
                                             encoded_uri_component_to_bstr(cmds.at(2)),
                                             stol(cmds.at(3)), stol(cmds.at(4))));
  case 371:
    return format(
  ...
  case 372:
    return format("{}", dm->WriteDataAddrFromBin(stol(cmds.at(1)), stoll(cmds.at(2)),
                                                 stol(cmds.at(3)), stol(cmds.at(4))));
  case 373:
  ...
  case 381:
    return format("{}", bstr_to_utf8(dm->VirtualQueryEx(stol(cmds.at(1)), stoll(cmds.at(2)),
                                                        stol(cmds.at(3)))));
  case 382:
    return format("{}", dm->AsmCallEx(stol(cmds.at(1)), stol(cmds.at(2)),
                                      encoded_uri_component_to_bstr(cmds.at(3))));
  case 383:
  ...
  case 389:
    return format("{}",
                  bstr_to_utf8(dm->GetRealPath(encoded_uri_component_to_bstr(cmds.at(1)))));
  case 390:
  ...
  case 392:
    return format("{}",
                  bstr_to_utf8(dm->DmGuardParams(encoded_uri_component_to_bstr(cmds.at(1)),
                                                 encoded_uri_component_to_bstr(cmds.at(2)),
                                                 encoded_uri_component_to_bstr(cmds.at(3)))));
  case 393:
    return format(
        "{}", dm->GetModuleSize(stol(cmds.at(1)), encoded_uri_component_to_bstr(cmds.at(2))));
  case 394:
  ...
  case 406:
    return format("{}", bstr_to_utf8(dm->GetSystemInfo(
                            encoded_uri_component_to_bstr(cmds.at(1)), stol(cmds.at(2)))));
  case 407:
    return format("{}", dm->SetFindPicMultithreadCount(stol(cmds.at(1))));
  case 408:
    return format("{},{},{}",
                  dm->FindPicSim(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                 stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                                 encoded_uri_component_to_bstr(cmds.at(6)), stol(cmds.at(7)),
                                 stol(cmds.at(8)), &x, &y),
                  x.intVal, y.intVal);
  case 409:
    return format("{}", bstr_to_utf8(dm->FindPicSimEx(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stol(cmds.at(7)),
                            stol(cmds.at(8)))));
  case 410:
    return format("{},{},{}",
                  dm->FindPicSimMem(stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                                    stol(cmds.at(4)),
                                    encoded_uri_component_to_bstr(cmds.at(5)),
                                    encoded_uri_component_to_bstr(cmds.at(6)),
                                    stol(cmds.at(7)), stol(cmds.at(8)), &x, &y),
                  x.intVal, y.intVal);
  case 411:
    return format("{}", bstr_to_utf8(dm->FindPicSimMemEx(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stol(cmds.at(7)),
                            stol(cmds.at(8)))));
  case 412:
    return format("{}", bstr_to_utf8(dm->FindPicSimE(stol(cmds.at(1)), stol(cmds.at(2)),
                                                     stol(cmds.at(3)), stol(cmds.at(4)),
                                                     encoded_uri_component_to_bstr(cmds.at(5)),
                                                     encoded_uri_component_to_bstr(cmds.at(6)),
                                                     stol(cmds.at(7)), stol(cmds.at(8)))));
  case 413:
    return format("{}", bstr_to_utf8(dm->FindPicSimMemE(
                            stol(cmds.at(1)), stol(cmds.at(2)), stol(cmds.at(3)),
                            stol(cmds.at(4)), encoded_uri_component_to_bstr(cmds.at(5)),
                            encoded_uri_component_to_bstr(cmds.at(6)), stol(cmds.at(7)),
                            stol(cmds.at(8)))));
