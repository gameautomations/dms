...
public interface Idmsoft
{
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(130)]
    long AsmCall([In] int hwnd, [In] int mode);
    ...
    [DispId(133)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string Assemble([In] long base_addr, [In] int is_64bit);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(134)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string DisAssemble([In][MarshalAs(UnmanagedType.BStr)] string asm_code, [In] long base_addr, [In] int is_64bit);
    ...
    [DispId(154)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string GetDiskSerial([In] int index);
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(171)]
    int DownCpu([In] int type, [In] int rate);
    ...
    [DispId(382)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string VirtualQueryEx([In] int hwnd, [In] long addr, [In] int pmbi);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(383)]
    long AsmCallEx([In] int hwnd, [In] int mode, [In][MarshalAs(UnmanagedType.BStr)] string base_addr);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(384)]
    long GetRemoteApiAddress([In] int hwnd, [In] long base_addr, [In][MarshalAs(UnmanagedType.BStr)] string fun_name);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(385)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string ExecuteCmd([In][MarshalAs(UnmanagedType.BStr)] string cmd, [In][MarshalAs(UnmanagedType.BStr)] string current_dir, [In] int time_out);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(386)]
    int SpeedNormalGraphic([In] int en);
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(389)]
    int HackSpeed([In] double rate);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(390)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string GetRealPath([In][MarshalAs(UnmanagedType.BStr)] string path);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(391)]
    int ShowTaskBarIcon([In] int hwnd, [In] int is_show);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(392)]
    int AsmSetTimeout([In] int time_out, [In] int param);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(393)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string DmGuardParams([In][MarshalAs(UnmanagedType.BStr)] string cmd, [In][MarshalAs(UnmanagedType.BStr)] string sub_cmd, [In][MarshalAs(UnmanagedType.BStr)] string param);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(394)]
    int GetModuleSize([In] int hwnd, [In][MarshalAs(UnmanagedType.BStr)] string module_name);
    ...
    [DispId(396)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string GetDiskModel([In] int index);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(397)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string GetDiskReversion([In] int index);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(398)]
    int EnableFindPicMultithread([In] int en);
    ...
    [DispId(401)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string Hex32([In] int v);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(402)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string Hex64([In] long v);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(403)]
    int GetWindowThreadId([In] int hwnd);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(404)]
    int DmGuardExtract([In][MarshalAs(UnmanagedType.BStr)] string type, [In][MarshalAs(UnmanagedType.BStr)] string path);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(405)]
    int DmGuardLoadCustom([In][MarshalAs(UnmanagedType.BStr)] string type, [In][MarshalAs(UnmanagedType.BStr)] string path);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(406)]
    int SetShowAsmErrorMsg([In] int show);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(407)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string GetSystemInfo([In][MarshalAs(UnmanagedType.BStr)] string type, [In] int method);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(408)]
    int SetFindPicMultithreadCount([In] int count);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(409)]
    int FindPicSim([In] int x1, [In] int y1, [In] int x2, [In] int y2, [In][MarshalAs(UnmanagedType.BStr)] string pic_name, [In][MarshalAs(UnmanagedType.BStr)] string delta_color, [In] int sim, [In] int dir, [MarshalAs(UnmanagedType.Struct)] out object x, [MarshalAs(UnmanagedType.Struct)] out object y);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(410)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string FindPicSimEx([In] int x1, [In] int y1, [In] int x2, [In] int y2, [In][MarshalAs(UnmanagedType.BStr)] string pic_name, [In][MarshalAs(UnmanagedType.BStr)] string delta_color, [In] int sim, [In] int dir);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(411)]
    int FindPicSimMem([In] int x1, [In] int y1, [In] int x2, [In] int y2, [In][MarshalAs(UnmanagedType.BStr)] string pic_info, [In][MarshalAs(UnmanagedType.BStr)] string delta_color, [In] int sim, [In] int dir, [MarshalAs(UnmanagedType.Struct)] out object x, [MarshalAs(UnmanagedType.Struct)] out object y);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(412)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string FindPicSimMemEx([In] int x1, [In] int y1, [In] int x2, [In] int y2, [In][MarshalAs(UnmanagedType.BStr)] string pic_info, [In][MarshalAs(UnmanagedType.BStr)] string delta_color, [In] int sim, [In] int dir);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(413)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string FindPicSimE([In] int x1, [In] int y1, [In] int x2, [In] int y2, [In][MarshalAs(UnmanagedType.BStr)] string pic_name, [In][MarshalAs(UnmanagedType.BStr)] string delta_color, [In] int sim, [In] int dir);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(414)]
    [return: MarshalAs(UnmanagedType.BStr)]
    string FindPicSimMemE([In] int x1, [In] int y1, [In] int x2, [In] int y2, [In][MarshalAs(UnmanagedType.BStr)] string pic_info, [In][MarshalAs(UnmanagedType.BStr)] string delta_color, [In] int sim, [In] int dir);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [DispId(415)]
    int SetInputDm([In] int input_dm, [In] int rx, [In] int ry);
}
